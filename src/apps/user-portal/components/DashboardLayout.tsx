...
import { Home, MessageSquare, BookOpen, Menu, X, ChevronLeft, ChevronRight, Settings, FileText, LogOut, ListChecks, Sparkles } from 'lucide-react';
...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  // 图标映射
  const iconMap = { Home, MessageSquare, BookOpen, FileText, ListChecks, Sparkles } as const;
