  ...
  const navigationSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'ip-ban', name: '封禁管理', icon: Shield, path: '/dashboard/admin/ip-ban' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'interview-questions', name: '题库管理', icon: ListChecks, path: '/dashboard/admin/interview-questions' },
        ...
        { id: 'ai-news', name: 'AI 日报', icon: Newspaper, path: '/dashboard/admin/ai-news' },
          ...
          <SidebarHeader className={isCollapsed ? 'px-2' : ''}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <img src="/logo.jpg" alt="Logo" className="h-8 w-8 rounded shrink-0 object-cover" />
